...
pathRes         = "/home/cleonard/dev/stage/results/scripts_results/BinaryFeatures/cascade-full/TaillesDif/ult-script3_BalancedDTB/"
...
for i in range(len(size)):
    ...
    for j in range(len(availableSplitsDict[dtb])):
        ...
        dtbPath     = pathBalancedDTB + dtb + "_balanced/"
        ...
        execAndPrintBashCmd(pathExec +"build/" + execName +
                               ...
                               " \"" + str(nbDtbElements) + "\"" +
                               " " + actName +
                               " " + dtbPath + " 1 > " + pathExec + "build/" + logsFile + ".log", "    ")
